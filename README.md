...
Small study materials for the AWS Certified Cloud Practitioner (CLF-C02) exam.

- `cheat-sheet.md`: exam-focused notes for core concepts and high-yield reminders.
